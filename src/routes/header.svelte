...
<div class="grid grid-flow-col justify-items-start items-center">
	<Logo />

	{#each headerLinks as link}
		<a
			class="justify-self-center hover:text-sky-700 transition duration-150"
			href={link.destination}>{link.name}</a
		>
	{/each}
